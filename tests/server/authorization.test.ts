...
const env = {
  APP_ENV: 'development', APP_ORIGIN: 'https://app.example', PATIENT_PROCESSING_APPROVED: 'true', SESSION_SIGNING_KEY: secret,
  ATRIUS_CLIENT_ID: 'test-client', ATRIUS_FHIR_BASE_URL: base,
  ATRIUS_AUTHORIZATION_URL: 'https://provider.example/auth', ATRIUS_TOKEN_URL: 'https://provider.example/token',
  CIGNA_CLIENT_ID: 'test-payer', CIGNA_FHIR_BASE_URL: base,
};
